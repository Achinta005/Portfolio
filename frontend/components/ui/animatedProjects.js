...
export const AnimatedTestimonials = ({ testimonials, autoplay = false }) => {
  ...
  return (
    <div className="mx-auto max-w-sm px-4 py-10 font-sans antialiased md:max-w-4xl">
  <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2 left-[-5vw]">
    ...
    <div className="flex flex-col justify-between py-4 w-[50vw]">
      <motion.div
        key={active}
        initial={{
          y: 20,
