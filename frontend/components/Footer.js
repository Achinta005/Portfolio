        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/#home" className="text-green-600 hover:text-blue-600 font-semibold dark:hover:text-white transition-colors cursor-pointer block w-fit">
                Home
              </Link>
              <Link href="/#about" className="text-green-600 hover:text-blue-600 font-semibold dark:hover:text-white transition-colors cursor-pointer block w-fit">
                About
              </Link>
              <Link href="/#projects" className="text-green-600 hover:text-blue-600 font-semibold dark:hover:text-white  transition-colors cursor-pointer block w-fit">
                Projects
              </Link>
              <Link href="/#contact" className="text-green-600 hover:text-blue-600 font-semibold dark:hover:text-white transition-colors cursor-pointer block w-fit">
                Contact
              </Link>
            </div>
          </div>
