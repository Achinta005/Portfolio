  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-pink-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '0.5s' }} />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <div className="relative w-40 h-40 mb-12">
          ...
          {/* Middle ring */}
          <div className="absolute inset-4 border-4 border-transparent border-t-blue-500 border-r-purple-500 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '2s' }} />
          {/* Inner ring */}
          <div className="absolute inset-8 border-4 border-transparent border-t-pink-400 border-r-blue-400 rounded-full animate-spin" style={{ animationDuration: '3s' }} />
          {/* Center pulsing orb */}
        ...
        <div className="text-center space-y-6 max-w-2xl">
          ...
          <p className="text-gray-300 text-xl">Crafting your journey story...</p>
          ...
          <div className="flex items-center justify-center gap-3 pt-4">
            ...
            <div className="w-4 h-4 bg-blue-400 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} />
          </div>
        </div>

        {/* Section preview cards */}
        <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6 w-full max-w-6xl">
          {['About Me', 'Skills', 'Education', 'Certifications'].map((section, i) => (
            <div key={i} className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-purple-500/20 animate-pulse" style={{ animationDelay: `${i * 0.1}s` }}>
