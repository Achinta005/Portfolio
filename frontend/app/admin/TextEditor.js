...
const TextEditor = ({ onDocumentSaved }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h3 className="text-lg font-semibold mb-4">Create a New Document</h3>
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <textarea value={content} onChange={(e) => setContent(e.target.value)} className="w-full px-3 py-2 border rounded-lg" rows="6" required />
        </div>
