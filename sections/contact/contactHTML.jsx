                ...
                >
                    ...
                    <div className="c-field" style={{ marginBottom: 14 }}>
                        ...
                        <textarea
                            ...
                            style={{ resize: "none", lineHeight: 1.6, minHeight: 88 }}
                        />
                    </div>
                    ...
                    <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                            <a
                                href="mailto:achintahazra815@gmail.com"
                                style={{
                                    display: "flex",
                                    alignItems: "center",
                                    gap: 8,
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "rgba(148,163,184,0.55)", fontSize: 12.5 }}>
                                ...
                                <span>Arambagh, West Bengal</span>
                                <span style={{
                                    fontSize: 10,
                                    fontWeight: 500,
